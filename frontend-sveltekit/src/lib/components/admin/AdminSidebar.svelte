<script lang="ts">
	...
	const navItems: NavItem[] = [
		...
		{ label: 'pSEO Dashboard', href: '/admin/pseo', icon: '🌍', group: 'pSEO' },
		{ label: 'Article Categories', href: '/admin/pseo/categories', icon: '🗂️', group: 'pSEO' },
		{ label: 'Article Tags', href: '/admin/pseo/tags', icon: '🏷️', group: 'pSEO' },
		{ label: 'Import / Export', href: '/admin/pseo/import', icon: '📥', group: 'pSEO' },
