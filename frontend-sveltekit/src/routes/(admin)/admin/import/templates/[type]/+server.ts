...
const TEMPLATES: Record<string, TemplateConfig> = {
	...
	supplier: {
		headers: [
			'id товара', 'Имя', 'Бренд', 'Артикул (Ref)', 'Цена', 'Фото', 'Коллекция',
			'Пол', 'Размер (мм)', 'Толщ, (мм)', 'Мех-м', 'Калибр', 'Запас хода',
			'Водозащита', 'Корпус', 'Ремешок/Браслет', 'Циферблат'
		],
		examples: [
			{
				'id товара': '10001', 'Имя': 'Часы Tissot T125.610.17.081.00, Tissot Supersport, T-Sport',
				'Бренд': 'Tissot', 'Артикул (Ref)': 'T125.610.17.081.00', 'Цена': '55336',
				'Фото': '10001', 'Коллекция': 'Supersport Gent', 'Пол': 'Мужские',
				'Размер (мм)': '44', 'Толщ, (мм)': '10', 'Мех-м': 'Кварц',
				'Калибр': 'ETA F06.115', 'Запас хода': '-', 'Водозащита': '100м',
				'Корпус': 'Сталь', 'Ремешок/Браслет': 'Ткань', 'Циферблат': 'Серый'
			},
			{
				'id товара': '10002', 'Имя': 'Часы Omega Seamaster 300',
				'Бренд': 'Omega', 'Артикул (Ref)': '210.30.42.20.03.001', 'Цена': '580000',
				'Фото': '10002', 'Коллекция': 'Seamaster', 'Пол': 'Мужские',
				'Размер (мм)': '42', 'Толщ, (мм)': '13,5', 'Мех-м': 'Авто',
				'Калибр': 'Co-Axial 8800', 'Запас хода': '55 часов', 'Водозащита': '300м',
				'Корпус': 'Сталь', 'Ремешок/Браслет': 'Браслет (Сталь)', 'Циферблат': 'Синий'
			}
		],
		filename: 'supplier-template.csv'
	}
};
