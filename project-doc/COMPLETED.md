...
### Session-17: Image Upload при импорте

> **Источник:** Moderator — нужна загрузка изображений отдельным ZIP, несколько фото на товар, дозагрузка фото
> **Приоритет:** HIGH
> **Roadmap:** `project-doc/session-17-image-upload/roadmap-start.md`

| Task | Summary | Status | Deployed |
|------|---------|--------|----------|
| 1 | UI — раздельные поля CSV и ZIP | ⏳ PENDING | - |
| 2 | Серверная обработка двух файлов | ⏳ PENDING | - |
| 3 | Множественные фото через `;` разделитель | ⏳ PENDING | - |
| 4 | Режим "Только ZIP" — обновление фото существующих товаров | ⏳ PENDING | - |
| 5 | Media endpoint для отдачи изображений | ⏳ PENDING | - |
| 6 | Интеграция с product_images таблицей | ⏳ PENDING | - |
